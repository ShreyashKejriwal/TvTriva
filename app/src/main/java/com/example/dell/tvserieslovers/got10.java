...
public class got10 extends AppCompatActivity {
    Button b1,b2,b3,b4;
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(got10.this, MainActivity.class));
        finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        if (i == 0) {
                            ...
                            c1 = new CountDownTimer(2000, 1000) {
                                ...
                                public void onFinish() {
                                    Intent intent = new Intent(got10.this, shuffle2.class);
        ...
        b2=(Button) findViewById(R.id.st);
        ...
        b3=(Button) findViewById(R.id.mc);
        ...
        ct=new CountDownTimer(20000,1000) {
            ...
            @Override
            public void onFinish () {
                Intent intent = new Intent(got10.this,end.class);
                intent.putExtra("int_value", c);
                startActivity(intent);
                TextView tv_result = (TextView) findViewById(R.id.tv_countdown);
