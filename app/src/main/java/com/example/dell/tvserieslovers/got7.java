...
public class got7 extends AppCompatActivity {
    Button b1,b2,b3,b4;
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(got7.this, MainActivity.class));
        finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.got7);
        b1 = (Button) findViewById(R.id.mc);
                        ...
                        if (i == 0) {
                            ...
                            c1 = new CountDownTimer(2000, 1000) {
                                ...
                                public void onFinish() {
                                    Intent intent = new Intent(got7.this, shuffle2.class);
        ...
        b2=(Button) findViewById(R.id.cl);
        ...
        b3=(Button) findViewById(R.id.noa);
        ...
        ct=new CountDownTimer(10000,1000) {
            ...
            @Override
            public void onFinish () {
                Intent intent = new Intent(got7.this,end.class);
                intent.putExtra("int_value", c);
                startActivity(intent);
                TextView tv_result = (TextView) findViewById(R.id.tv_countdown);
