...
public class got6 extends AppCompatActivity {
    Button b1,b2,b3,b4;
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(got6.this, MainActivity.class));
        finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        if (i == 0) {
                            ...
                            c1 = new CountDownTimer(2000, 1000) {
                                ...
                                public void onFinish() {
                                    Intent intent = new Intent(got6.this, shuffle2.class);
        ...
        ct=new CountDownTimer(10000,1000) {
            ...
            @Override
            public void onFinish () {
                Intent intent = new Intent(got6.this,end.class);
                intent.putExtra("int_value", c);
                startActivity(intent);
                TextView tv_result = (TextView) findViewById(R.id.tv_countdown);
